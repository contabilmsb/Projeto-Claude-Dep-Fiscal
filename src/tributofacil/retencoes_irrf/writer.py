"""
Geração do Excel consolidado de Retenções IRRF.
"""
...
COLS_DATA = {"Data do Arquivo IRRF"}
...
LARGURAS_ACUMULADO = {
    ...
    "Nome/Razão Social do Fornecedor": 40,
    "CNPJ do Fornecedor": 18,
    "Data do Arquivo IRRF (mais recente)": 22,
    "Base de Cálculo": 16,
    "IRRF Retido": 14,
}
COLS_MOEDA_ACUMULADO = {"Base de Cálculo", "IRRF Retido"}
COLS_DATA_ACUMULADO = {"Data do Arquivo IRRF (mais recente)"}
...
def gerar_excel(df: pd.DataFrame, df_acumulado: pd.DataFrame, avisos: list[str]) -> bytes:
    ...
    _escrever_planilha(
        ...
        colunas_total=["Base de Cálculo", "IRRF Retido"],
    )

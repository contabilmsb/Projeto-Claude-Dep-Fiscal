...
# tributária por antecipação (art. 289, §17, do RICMS-BA). Toda mercadoria
# fora do Anexo 1 se enquadra em uma destas categorias — não há opção
# "sem MVA", pois a própria lei prevê uma margem genérica para esses casos.

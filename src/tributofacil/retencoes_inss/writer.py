"""
Geração do Excel consolidado de Retenções INSS.
"""
...
COLS_DATA = {"Data do Arquivo INSS"}
...
LARGURAS_ACUMULADO = {
    ...
    "Nome/Razão Social do Fornecedor": 40,
    "CNPJ do Fornecedor": 18,
    "Data do Arquivo INSS (mais recente)": 22,
    "Base de Cálculo": 16,
    "INSS Retido": 14,
}
COLS_MOEDA_ACUMULADO = {"Base de Cálculo", "INSS Retido"}
COLS_DATA_ACUMULADO = {"Data do Arquivo INSS (mais recente)"}
...
def gerar_excel(df: pd.DataFrame, df_acumulado: pd.DataFrame, avisos: list[str]) -> bytes:
    ...
    _escrever_planilha(
        ...
        colunas_total=["Base de Cálculo", "INSS Retido"],
    )
